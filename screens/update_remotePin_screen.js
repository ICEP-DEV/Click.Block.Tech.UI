...
export default function UpdateRemotePin({navigation}) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerText}>Update Remote PIN</Text>
        ...
        <ScrollView contentContainerStyle={styles.cardContainer}>
          <View style={styles.card}>
            <TextInput
              style={styles.input}
              placeholder={'Enter your old Remote PIN'}
              secureTextEntry
            ...
            <TextInput
              style={styles.input}
              placeholder={'Enter yor new 5-digit Remote PIN'}
              secureTextEntry
              keyboardType="numeric"
              maxLength={5}
            ...
            <TextInput
              style={styles.input}
              placeholder={'Confirm your new 5-digit Remote PIN'}
              secureTextEntry
              keyboardType="numeric"
              maxLength={5}
            />
            ...
            <TouchableOpacity style={styles.submitButton} onPress={()=>{}}>
              <Text style={styles.submitButtonText}>Update Remote PIN</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </View>
