...
export default function UpdateAlertPin({navigation}) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerText}>Update Alert PIN</Text>
        ...
        <ScrollView contentContainerStyle={styles.cardContainer}>
          <View style={styles.card}>
            <TextInput
              style={styles.input}
              placeholder={'Enter your old Alert PIN'}
              secureTextEntry
            ...
            <TextInput
              style={styles.input}
              placeholder={'Enter yor new 5-digit Alert PIN'}
              secureTextEntry
              keyboardType="numeric"
              maxLength={5}
            ...
            <TouchableOpacity style={styles.submitButton} onPress={()=>{}}>
              <Text style={styles.submitButtonText}>Update Alert PIN</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </View>
